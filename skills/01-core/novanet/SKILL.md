---
name: novanet
description: NovaNet knowledge graph reference - 8 MCP tools for context assembly, content generation, and SEO operations. Use when user asks about novanet_generate, novanet_write,8 MCP tools, schema, or knowledge graph queries.
argument-hint: "[topic]"
---
